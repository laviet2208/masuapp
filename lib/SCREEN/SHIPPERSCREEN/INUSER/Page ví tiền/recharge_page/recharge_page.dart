...
class recharge_page extends StatefulWidget {
  const recharge_page({Key? key}) : super(key: key);

  @override
  State<recharge_page> createState() => _recharge_pageState();
}

class _recharge_pageState extends State<recharge_page> {
  @override
                      ...
                      child: RichText(
                        text: TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text: ' Chuyển khoản vào số tài khoản , tên tài khoản Nguyễn Minh Ngọc',
                              style: TextStyle(
                                fontSize: 18,
                                fontFamily: 'arial',
                                color: Colors.black,
