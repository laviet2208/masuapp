...
class Itemdicho extends StatefulWidget {
  final double width;
  final foodOrder order;
  const Itemdicho({Key? key, required this.width, required this.order}) : super(key: key);

  @override
  State<Itemdicho> createState() => _ItemdoanState();
}

class _ItemdoanState extends State<Itemdicho> {
