...
import 'package:masuapp/GENERAL/models/autocomplate_prediction.dart';
import 'package:masuapp/GENERAL/models/place_auto_complate_response.dart';
import 'package:masuapp/GENERAL/utils/utils.dart';
import 'package:masuapp/SCREEN/RESTAURANT/SCREENfoodcart.dart';
import 'package:uuid/uuid.dart';
import 'package:masuapp/SCREEN/STORE/SCREENstorecart.dart';

import '../../../FINAL/finalClass.dart';
import '../../../GENERAL/NormalUser/accountLocation.dart';
import '../../../GENERAL/Tool/Tool.dart';
import '../../../ITEM/ITEMplaceAutoComplete.dart';
import 'SCREEN_LOCATION_STORE1.dart';

class SCREENlocationstore extends StatefulWidget {
  final accountLocation location;
  const SCREENlocationstore({Key? key, required this.location}) : super(key: key);

  @override
  State<SCREENlocationstore> createState() => _SCREENlocationitemsendst1State();
}

class _SCREENlocationitemsendst1State extends State<SCREENlocationstore> {
                            ...
                            children: <Widget>[
                              ...
                              Positioned(
                                  ...
                                  child: Container(
                                    width: screenWidth/2,
                                    child: Text(
                                      "Chúng tôi sẽ đi chợ giúp bạn ở bất kỳ đâu!",
                                      style: TextStyle(
                                        fontSize: 16,
                                        fontFamily: 'arial',
                                        color: Colors.black,
                              ...
                              Positioned(
                                ...
                                child: GestureDetector(
                                  ...
                                  onTap: () {
                                    ...
                                    toastMessage('Bạn không thể thay đổi địa chỉ cửa hàng');
                                  },
                                ),
                              ),
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    ...
                    onTap: () async {
                      ...
                      Navigator.push(context, MaterialPageRoute(builder:(context) => SCREENlocationstore1(Distance: distance, diemlay: diemnhahang, diemtra: diemtra,)));
