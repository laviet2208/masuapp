...
import 'package:masuapp/GENERAL/NormalUser/accountLocation.dart';
import 'package:masuapp/GENERAL/Tool/Tool.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;
import 'package:uuid/uuid.dart';
import 'package:masuapp/SCREEN/FEATURE/SCREEN_CARORDER/SCREEN_LOCATION_CAR_ST2.dart';
...
class SCREENcarorder extends StatefulWidget {
  const SCREENcarorder({Key? key}) : super(key: key);

  @override
  State<SCREENcarorder> createState() => _SCREENcarorderState();
}

class _SCREENcarorderState extends State<SCREENcarorder> {
                              ...
                              children: <Widget>[
                                ...
                                Positioned(
                                    ...
                                    child: Container(
                                      width: screenWidth/2,
                                      child: Text(
                                        "Nhanh chóng , sang trọng , tiện lợi!",
                                        style: TextStyle(
                                          fontSize: 16,
                                          fontFamily: 'arial',
                                          color: Colors.black,
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                              fit: BoxFit.cover,
                                              image: AssetImage('assets/image/linhtinh2.png')
                                          )
                                      ),
                                    )
                                ),
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      ...
                      onTap: () async {
                        ...
                        Navigator.push(context, MaterialPageRoute(builder:(context) => SCREENlocationcarst2(Distance: distance, diemdon: diemdonkhach, diemtra: diemtrakhach,)));
                      },
                    ),
                  )
                ],
