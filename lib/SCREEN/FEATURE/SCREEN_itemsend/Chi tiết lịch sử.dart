...
import 'package:masuapp/GENERAL/Order/Cost.dart';
import 'package:masuapp/GENERAL/Order/Receiver.dart';
import 'package:masuapp/GENERAL/Order/catchOrder.dart';
import 'package:masuapp/GENERAL/Order/foodOrder.dart';
import 'package:masuapp/GENERAL/Order/item_details.dart';
import 'package:masuapp/GENERAL/Order/itemsendOrder.dart';
import 'package:masuapp/GENERAL/Product/Voucher.dart';
import 'package:masuapp/GENERAL/utils/utils.dart';
import 'package:masuapp/OTHER/Button/Buttontype1.dart';
import 'package:flutter_polyline_points/flutter_polyline_points.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:masuapp/SCREEN/HISTORY/SCREENhistorysend.dart';
...
class _SCREENwaitbikerState extends State<SCREENitemHisDetail> {
  ...
  itemsendOrder thiscatch = itemsendOrder(
    id: '',
    cost: -1,
    owner: accountNormal(id: "NA", avatarID: "NA", createTime: Time(second: 0, minute: 0, hour: 0, day: 0, month: 0, year: 0), status: 1, name: "NA", phoneNum: "NA", type: 0, locationHis: accountLocation(phoneNum: '', LocationID: '', Latitude: 0, Longitude: 0, firstText: '', secondaryText: ''), totalMoney: 0, Area: '', license: '', WorkStatus: 0),
    shipper: accountNormal(id: "NA", avatarID: "NA", createTime: Time(second: 0, minute: 0, hour: 0, day: 0, month: 0, year: 0), status: 1, name: "NA", phoneNum: "NA", type: 0, locationHis: accountLocation(phoneNum: '', LocationID: '', Latitude: 0, Longitude: 0, firstText: '', secondaryText: ''), totalMoney: 0, Area: '', license: '', WorkStatus: 0), status: '',
