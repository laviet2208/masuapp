...
import 'package:masuapp/GENERAL/ShopUser/accountShop.dart';
import 'package:masuapp/SCREEN/INUSER/PAGE_HOME/ITEM%20nh%C3%A0%20h%C3%A0ng%20g%E1%BA%A7n.dart';
import 'package:masuapp/SCREEN/INUSER/PAGE_HOME/T%C3%ADnh%20kho%E1%BA%A3ng%20c%C3%A1ch.dart';
import 'package:masuapp/SCREEN/RESTAURANT/SCREENshopmain.dart';

import '../SCREENshopview.dart';

class SCREENviewTypeshop extends StatefulWidget {
  final int Type;
  final String Title;
  const SCREENviewTypeshop({Key? key, required this.Type, required this.Title}) : super(key: key);

  @override
  State<SCREENviewTypeshop> createState() => _SCREENviewTypeshopState();
}

class _SCREENviewTypeshopState extends State<SCREENviewTypeshop> {
