...
class complete_catch_order_bike_item extends StatelessWidget {
  final catchOrderType3 order;
  const complete_catch_order_bike_item({super.key, required this.order});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        width: width/2,
                        child: AutoSizeText(
                          order.type == 1 ? 'Đơn chở người' : 'Đơn lái hộ',
                          style: TextStyle(
                              fontSize: 100,
                              color: Colors.grey,
                              fontFamily: 'muli'
      ...
      onTap: () {
        Navigator.pushReplacement(context, MaterialPageRoute(builder:(context) => view_un_catch_order_type_3_detail_screen(id: order.id)));
      },
    );
  }
}
