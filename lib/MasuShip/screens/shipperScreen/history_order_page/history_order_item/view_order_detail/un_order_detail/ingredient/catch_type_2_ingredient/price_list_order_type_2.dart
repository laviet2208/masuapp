              ...
              child: Container(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      cost_ingredient.right_title_cost(order.locationGet.longitude != 0 ? (getStringNumber(order.cost - ((order.cost) * (order.costFee.discount/100))) + 'đ') : 'Chưa tới nơi' , Colors.black, FontWeight.normal),
                    ],
                  )
              ),
            ),
