...
class catch_order_have_type_2_dialog extends StatefulWidget {
  final CatchOrder order;
  const catch_order_have_type_2_dialog({Key? key, required this.order,}) : super(key: key);

  @override
  State<catch_order_have_type_2_dialog> createState() => _catch_order_have_type_2_dialogState();
}

class _catch_order_have_type_2_dialogState extends State<catch_order_have_type_2_dialog> {
