...
class change_account_shipper_info extends StatefulWidget {
  const change_account_shipper_info({Key? key}) : super(key: key);

  @override
  State<change_account_shipper_info> createState() => _change_account_shipper_infoState();
}

class _change_account_shipper_infoState extends State<change_account_shipper_info> {
  final namecontroller = TextEditingController();
  final phonecontroller = TextEditingController();
  bool loading = false;
  Future<void> change_data(String name) async {
    final reference = FirebaseDatabase.instance.reference();
    await reference.child("Account/" + finalData.shipper_account.id + "/name").set(name);
  }
  ...
  void initState() {
    ...
    super.initState();
    namecontroller.text = finalData.shipper_account.name;
    if (finalData.shipper_account.phone[0] == '0') {
      phonecontroller.text = finalData.shipper_account.phone;
    } else {
      phonecontroller.text = '0' + finalData.shipper_account.phone;
    }
  }
