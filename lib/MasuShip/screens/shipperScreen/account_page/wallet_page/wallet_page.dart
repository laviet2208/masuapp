...
import 'package:masuapp/MasuShip/screens/shipperScreen/account_page/wallet_page/wallet_item.dart';
import 'package:masuapp/MasuShip/screens/shipperScreen/main_screen/shipper_main_screen.dart';
import 'package:masuapp/SCREEN/SHIPPERSCREEN/INUSER/Page%20v%C3%AD%20ti%E1%BB%81n/recharge_page/recharge_page.dart';
...
class _wallet_pageState extends State<wallet_page> {
  List<historyTransactionData> hisList = [];

  void getData() {
    final reference = FirebaseDatabase.instance.reference();
    reference.child("historyTransaction").orderByChild('receiverId').equalTo(finalData.shipper_account.id).onValue.listen((event) {
      hisList.clear();
      final dynamic orders = event.snapshot.value;
      orders.forEach((key, value) {
        historyTransactionData his = historyTransactionData.fromJson(value);
        hisList.add(his);
        setState(() {
                            ...
                            children: <Widget>[
                              Positioned(
                                ...
                                child: GestureDetector(
                                  ...
                                  onTap: () {
                                    Navigator.push(context, MaterialPageRoute(builder:(context) => recharge_page()));
                                  },
                                ),
                              ),
                          ...
                          child : Container(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context , index) {
                                  return wallet_item(data: hisList[index],);
                                }
                            ),
                          )
                      )
