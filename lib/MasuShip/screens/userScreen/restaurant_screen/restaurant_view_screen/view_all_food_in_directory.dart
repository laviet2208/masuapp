...
class view_all_food_in_directory extends StatefulWidget {
  final Widget beforeWidget;
  final productDirectory directory;
  final VoidCallback event;
  const view_all_food_in_directory({super.key, required this.beforeWidget, required this.directory, required this.event});

  @override
  State<view_all_food_in_directory> createState() => _view_all_food_in_directoryState();
}

class _view_all_food_in_directoryState extends State<view_all_food_in_directory> {
  @override
