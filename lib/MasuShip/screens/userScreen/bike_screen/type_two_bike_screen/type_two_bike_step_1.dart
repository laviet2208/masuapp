          ...
          child: ListView(
            children: [
              ...
              Padding(
                ...
                child: GestureDetector(
                  child: Container(
                    height: location_set.longitude != 0 ? 45 : 0,
                    decoration: location_set.longitude != 0 ?  BoxDecoration(
                      borderRadius: BorderRadius.circular(1000),
                      gradient: LinearGradient(
                  ...
                  onTap: () {
                    ...
                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => type_two_bike_step_2(start_location: location_set,),),);
                  },
                ),
              ),
            ],
