...
class express_controller {
  static Future<void> cancel_order(expressOrder order) async {
  ...
  static Future<void> cancel_catch_order_discount(expressOrder order, shipperAccount shipper_account) async {
