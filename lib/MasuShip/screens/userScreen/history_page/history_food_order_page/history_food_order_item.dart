...
import '../../restaurant_screen/food_order_screen/food_order_wait.dart';

class history_food_order_item extends StatelessWidget {
  final foodOrder order;
  const history_food_order_item({super.key, required this.order});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Positioned(
                          ...
                          right: 0,
                          child: Text(
                            getAllTimeString(order.timeList[0]),
      ...
      onTap: () {
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => food_order_wait(id: order.id),),);
      },
    );
  }
}
