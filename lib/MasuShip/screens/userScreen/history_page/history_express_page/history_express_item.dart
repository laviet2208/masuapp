...
class history_express_item extends StatelessWidget {
  final expressOrder order;
  const history_express_item({super.key, required this.order});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onTap: () {
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => express_wait(id: order.id),),);
      },
    );
  }
}
