...
import 'package:masuapp/MasuShip/screens/userScreen/history_page/history_request_page/history_request_item.dart';

import '../../../../Data/OrderData/requestBuyOrderData/requestBuyOrder.dart';

class history_request_page extends StatefulWidget {
  const history_request_page({super.key});

  @override
  State<history_request_page> createState() => _history_request_pageState();
}

class _history_request_pageState extends State<history_request_page> {
            ...
            child: chosenList.length != 0 ? ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: history_request_item(order: chosenList[index]),
                );
              },
