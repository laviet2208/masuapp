...
import '../../bike_screen/type_one_bike_screen/ingredient/type_one_wait_ingredient/back_button_in_wait.dart';
import '../../express_screen/ingredient/location_title_custom_express.dart';
import '../../main_screen/user_main_screen.dart';
import '../../restaurant_screen/food_order_screen/ingredient/cancel_food_order_button.dart';
import '../../restaurant_screen/food_order_screen/ingredient/food_order_log.dart';
import '../../general/title_gradient_container.dart';
import 'cart_screen/product_order_step_1/item_food_view.dart';

class product_order_wait extends StatefulWidget {
  final String id;
  const product_order_wait({super.key, required this.id});

  @override
  State<product_order_wait> createState() => _product_order_waitState();
}

class _product_order_waitState extends State<product_order_wait> {
                  ...
                  child: Stack(
                    children: <Widget>[
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              location_title_custom_express(type: 'start', title: 'Điểm nhận hàng hóa'),
                      ...
                      Positioned(
                        top: 0,
                        left: 30,
                        child: title_gradient_container(icon: Icons.add_location_alt_outlined, title: 'Vị trí nhận hàng hóa'),
                      ),
                    ],
                  ),
                ),
                  ...
                  child: Stack(
                    children: <Widget>[
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return Padding(
                                    ...
                                    child: item_product_view(product: order.productList[index],),
                                  );
                                },
                              ),
                            ),
                      ...
                      Positioned(
                        top: 0,
                        left: 30,
                        child: title_gradient_container(icon: Icons.fastfood_outlined, title: 'Danh sách hàng hóa'),
                      ),
                    ],
                  ),
                ),
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: general_ingredient.get_cost_title('Giá tiền hàng hóa', Colors.black, FontWeight.bold, width),
                                    ),
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsets.only(top: 7, bottom: 7),
                                      child: general_ingredient.get_cost_title('Phụ thu chờ đợi', Colors.black, FontWeight.bold, width),
                                    ),
